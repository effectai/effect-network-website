    ...
    <div class="token-hero has-navbar-fixed-top">
      <section class="section">
        <div class="container my-6">
          <div class="columns">
            <div class="column is-two-fifth pr-6">
              ...
              <p>
                ...
                monetize and power AI solutions. EFX can be earned or bought and
                can be used in a decentralized ecosystem of AI-related services.
              </p>
            </div>
              ...
              <div class="block">
                <small
                  ...
                  <a
                    ...
                    href="https://bscscan.com/token/0xC51Ef828319b131B595b7ec4B28210eCf4d05aD0"
                    target="_blank"
                    >0xc51ef828319b131b595b7ec4b28210ecf4d05ad0</a
                  ></small
                >
              </div>
              <div>
                <small
                  ...
                  <a
                    class="blockchain-address"
                    href="https://www.bloks.io/account/effecttokens"
                    target="_blank"
                    >effecttokens</a
                  ></small
                >
          ...
          >
            <section
              class="section has-background-secondary-alt has-radius background-image efx-graph"
            >
              <img src="@/assets/img/efx-blue-2.png" class="efx-coin" />
              <div class="has-text-centered block">
                <h2 class="title is-2 has-text-white">Buy EFX</h2>
                <p class="subtitle has-text-white pt-3 mb-6">
                  Buy EFX tokens with BTC, EOS or USDT
                </p>
              </div>
              <div class="columns has-text-grey has-text-centered is-multiline">
                ...
                >
                  <div class="has-background-white has-radius px-6 pt-5 pb-2">
                    <div style="min-height: 70px" class="pt-2">
                      <img
                        width="100%"
                    ...
                    <a
                      class="button is-secondary is-outlined is-fullwidth has-text-weight-semibold"
                ...
                >
                  <div class="has-background-white has-radius px-6 pt-5 pb-2">
                    ...
                    <a
                      class="button is-secondary is-outlined is-fullwidth has-text-weight-semibold"
                      href="https://trade.orionprotocol.io/trade/EFX-USDT"
                      target="_blank"
                      >Buy EFX
                    </a>
      ...
      <div class="container is-max-widescreen mb-6">
        ...
        <div class="columns mt-6">
          <div class="column is-one-third is-full-mobile px-5">
            <div
              class="p-5 is-flex is-justify-content-space-between is-flex-direction-column"
            >
              <img
                src="~assets/img/icons/earn.svg"
              ...
              <a
                target="_blank"
                class="mt-5 is-align-self-flex-end"
                href="https://app.effect.network"
                >Join WorkForce
                <img
                  src="~assets/img/icons/turned-arrow.svg"
                  style="height: 15px"
              /></a>
            </div>
          </div>
          <div class="column is-one-third is-full-mobile px-5">
            ...
            >
              <img
                src="~assets/img/icons/stake.svg"
                class="is-align-self-flex-end"
                style="height: 70px"
              />
              ...
              <a
                target="_blank"
                class="mt-5 is-align-self-flex-end"
                href="https://dao.effect.network/stake"
                >Stake EFX
                <img
                  src="~assets/img/icons/turned-arrow.svg"
                  style="height: 15px"
          ...
          <div class="column is-one-third is-full-mobile px-5">
            ...
            >
              <img
                src="~assets/img/icons/vote.svg"
                class="is-align-self-flex-end"
                style="height: 70px"
              />
              <h3 class="title is-4 has-text-weight-semibold">Governance</h3>
              <p>
                Receive funding for proposals, vote and collect fees with your
                NFX tokens
              </p>
              <a
                target="_blank"
                class="mt-5 is-align-self-flex-end"
                href="https://dao.effect.network/dao"
                >Explore DAO
                <img
                  src="~assets/img/icons/turned-arrow.svg"
                  style="height: 15px"
          ...
          <div class="has-text-centered tokenomics pt-6">
            ...
            <div class="table-container">
              ...
              >
                ...
                <tbody>
                  <tr
                    v-for="(label, index) in chartData.datasets[0].labels"
                    :key="label"
                  >
                    <td>
                      {{ label }}
                      <span
                        v-if="chartData.datasets[0].meta[index].description"
                        class="is-pulled-right"
                        :data-tooltip="
                          chartData.datasets[0].meta[index].description
                        "
                      >
                    ...
                    <td class="has-text-right">
                      {{
                        hello(
                          balances[chartData.datasets[0].meta[index].balanceKey]
                        )
                      }}
                      EFX
                    </td>
              ...
              >
                ...
                <tbody>
                  <tr v-for="contract in contracts" :key="contract.account">
                    ...
                    <td>
                      <a :href="contract.source" target="_blank">view source</a>
                    </td>
                  </tr>
                </tbody>
              </table>
...
export default {
      ...
      contracts: [
        {
          ...
          source:
            "https://github.com/effectai/effect-network/tree/master/contracts/token",
        },
        {
          ...
          source:
            "https://github.com/effectai/effect-network-eos/blob/master/contracts/stake/stake.cpp",
        },
        {
          name: "Token Swap",
          description:
            "Verifies NEO transactions with an Oracle and issues EFX tokens on EOS",
          ...
          source:
            "https://github.com/effectai/effect-network-eos/blob/master/contracts/swap/swap.cpp",
        },
        {
          name: "EffectDAO",
          description:
            "Holds the registry of the members and guardians of the EffectDAO",
          ...
          source:
            "https://github.com/effectai/effect-network/blob/master/contracts/dao/dao.cpp",
        },
        {
          name: "Effect Proposals",
          description:
            "Stores proposals and handles the voting machanism of the EffectDAO",
          ...
          source:
            "https://github.com/effectai/effect-network-eos/blob/proposals/contracts/effect-proposals/effect-proposals.cpp",
        },
        {
        ...
        datasets: [
          {
            ...
            meta: [
              ...
              },
              {
                ...
                locked: false,
                description:
                  "Funds allocated for providing liquidity and partnership.",
              ...
              },
              {
                ...
                locked: true,
                description:
                  "Tokens governed by the DAO, from here proposals are funded.",
  ...
  methods: {
    async getBscBalance() {
      ...
      const balance = await efxContract.methods
        .totalSupply()
        .call()
        .catch(console.log);
    ...
    async getBalances() {
      ...
      const circSupply = parseInt(
        ...
        )[0].supply.circulating
      );
      this.balances.liquidBalanceBsc = parseInt(await this.getBscBalance());
      this.balances.daoBalance = parseInt(
        (
          await this.$eos.rpc.get_currency_balance(
            "effecttokens",
            "treasury.efx",
            "EFX"
          )
      ...
      this.balances.stakeBalance = parseInt(
        (
          await this.$eos.rpc.get_currency_balance(
            "effecttokens",
            "efxstakepool",
      ...
      this.balances.liquidityBalance = parseInt(
        (
          await this.$eos.rpc.get_currency_balance(
            "effecttokens",
            "bsc.efx",
      ...
      this.balances.liquidBalance =
        ...
        this.balances.liquidBalanceBsc;
      ...
      this.balances.circulating =
        this.balances.liquidBalanceBsc +
        this.balances.liquidBalance +
        this.balances.stakeBalance +
        this.balances.liquidityBalance;
      this.balances.noncirculating =
        this.balances.foundationBalance + this.balances.daoBalance;
